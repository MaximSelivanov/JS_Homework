...
/*исправить
- почтовый сервис лучше составить по принципу цифры и буквы от 1 до 10, точка-тире и цифры и буквы от 1 до 10*/
...
- могу сделать 8-0-
- цифры сокращаем
- в осн части номера только первая цифра не должна быть 0
- -?[0-9]{2} дублир. часть можно сократить*/

function numberCheck (number) {
    var number;
    return /^((\+?375-?)|8-?0)(25|29|33|44)-?[1-9]{1}\d{2}(-?\d{2}){2}$/.test(number);
}
...
console.log(numberCheck('8-0-33-66666666'));
